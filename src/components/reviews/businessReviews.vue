<template>
    ...
    <div v-if="business != null">
        <review-form :business="business"></review-form>
        <div class="columns">
        ...
        <div class="modal" :class="{'is-active': commentsModalActive}" v-if="commentsModalActive && selectedReview != null">
            <div class="modal-background"></div>
            <div class="modal-content">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getBusinessReviews() {
                axios
                    .get('/get-reviews', {params: {business_id_to_get: this.business.id, page: this.reviewsPage}})
                    .then(response => {
