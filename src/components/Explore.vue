    ...
    export default {
        ...
        watch: {
            selectedCategory() {
                ...
                this.reset(); 
                this.getCategoryBusinesses(selectedCategory.id);
            }
        },
        ...
        methods: {
            ...
            selectCategory(category) {
                ...
                if (this.$route.params.id != category.id) {
                    this.$router.push('/explore/' + category.id);
                    this.$router.replace({ selectedCategory: category });
                }
