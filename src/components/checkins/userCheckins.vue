                    ...
                    <div class="media-content">
                        <div class="content">
                            <p style="margin-bottom: 0">
                                ...
                                <br>
                                <strong><router-link :to="{ name: 'Business', params: { name: getSlug(checkin.business.name), id:checkin.business.id }}">{{ checkin.business.name }}</router-link></strong>
                                <br>
                            </p>
                        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getUserCheckins() {
                axios
                    .get('/get-checkins', {params: {user_id_to_get: this.user.id, page: this.checkinsPage}})
                    .then(response => {
