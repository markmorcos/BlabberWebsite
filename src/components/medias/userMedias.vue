                        ...
                        <div class="card-content" style="padding: 1rem">
                            <div class="media">
                                ...
                                <div class="media-content">
                                    <router-link :to="{ name: 'Profile', params: { name: getSlug(media.user.name), id:media.user.id }}" class="title is-4">{{media.user.name}} <small>{{media.business.name}}</small></router-link>
                                </div>
                            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getUserMedias() {
                axios
                    .get('/get-media', {params: {user_id_to_get: this.user.id, page: this.mediasPage}})
                    .then(response => {
